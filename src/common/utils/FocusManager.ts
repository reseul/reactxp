...
export abstract class FocusManager {
    ...
    protected abstract /* static */ addFocusListenerOnComponent(component: React.Component<any, any>, onFocus: EventListener): void;
    protected abstract /* static */ removeFocusListenerFromComponent(component: React.Component<any, any>, onFocus: EventListener): void;
